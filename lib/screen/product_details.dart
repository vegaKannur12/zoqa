...
class _ProductDetailsState extends State<ProductDetails> {
  ...
  void initState() {
    ...
    super.initState();
    // final auth = Provider.of<Controller>(context, listen: false);
  }
              ...
              return Column(
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: 
                    Image.network("https://www.clipartmax.com/png/full/449-4492509_lefroy-ice-breakers-minor-hockey-tournament-sorry-no-image-available.png"),
                  ): CarouselSlider(
                      ...
                      return Builder(
                        builder: (BuildContext context) {
                          return Container(
                            ...
                            child: Image.network(imageurl + image.piFiles!),
                          );
                        },
                      );
                    }).toList(),
                  ...
                  Row(
                    ...
                    children: value.imageList!.map(
                      (image) {
                        int index = value.imageList!.indexOf(image);
                        return Container(
                            ...
                            child: value.colorList!.isNotEmpty &&
                                ...
                                : Container(
                                    decoration: BoxDecoration(
                                      ...
                                      // color: Color(
                                      //   // int.parse( value
                                      //   // .colorList![indexlisview].colorHex!)
